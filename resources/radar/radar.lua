...
local function renderRadar()
			...
			-- menu text
			drawTxt2({titleDraw[1], titleDraw[2]}, {0.01, 0.01}, 0.45, 1, "NIC RADAR", {255,255,255,255}, 1)

			-- veh text
			-- FRWD
			drawTxt2({element1Draw[1], element1Draw[2]}, {0.01, 0.01}, 0.4, 0, "~b~FRWD", {255,255,255,255}, 1)
			-- Speed TXT
			drawTxt2({element1Draw[1], element1Draw[2] + 0.023}, {0.01, 0.01}, 0.7, 0, string.format("%s", tostring(round(lastVeh.frwd.speed, 2))), {255,255,255,255}, 1)
			-- Plate Veh TXT
			drawTxt2({element1Draw[1], element1Draw[2] + 0.076}, {0.01, 0.01}, 0.35, 1, string.format("~y~%s ~w~/ ~y~%s", lastVeh.frwd.plate, lastVeh.frwd.model), {255,255,255,255}, 1)

			-- veh text
			-- BKWD
			drawTxt2({element2Draw[1], element2Draw[2]}, {0.01, 0.01}, 0.4, 0, "~b~BCKWD", {255,255,255,255}, 1)
			-- Speed TXT
			drawTxt2({element2Draw[1], element2Draw[2] + 0.023}, {0.01, 0.01}, 0.7, 0, string.format("%s", tostring(round(lastVeh.bckwd.speed, 2))), {255,255,255,255}, 1)
			-- Plate Veh TXT
			drawTxt2({element2Draw[1], element2Draw[2] + 0.076}, {0.01, 0.01}, 0.35, 1, string.format("~y~%s ~w~/ ~y~%s", lastVeh.bckwd.plate, lastVeh.bckwd.model), {255,255,255,255}, 1)

			-- fast text
			-- FAST
			drawTxt2({element3Draw[1], element3Draw[2]}, {0.01, 0.01}, 0.4, 0, "~r~FAST", {255,255,255,255}, 1)
			-- Speed TXT
			drawTxt2({element3Draw[1], element3Draw[2] + 0.023}, {0.01, 0.01}, 0.7, 0, string.format("%s", tostring(round(lastVehFast.speed, 2))), {255,255,255,255}, 1)
			-- Plate Veh TXT
			drawTxt2({element3Draw[1], element3Draw[2] + 0.076}, {0.01, 0.01}, 0.35, 1, string.format("~y~%s ~w~/ ~y~%s", lastVehFast.plate, lastVehFast.model), {255,255,255,255}, 1)
			-- Fast Speed Display
			...
			-- patrol text
			-- PATROL
			drawTxt2({element4Draw[1], element4Draw[2]}, {0.01, 0.01}, 0.4, 0, "~y~PATROL", {255,255,255,255}, 1)
			-- Speed TXT
...
Citizen.CreateThread(function()
	while true do
		...
		if IsControlJustReleased(1, 47) and _whitelist then -- G
